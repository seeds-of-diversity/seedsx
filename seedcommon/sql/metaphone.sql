-- This SQL implements the Double Metaphone algorithm (c) 1998, 1999 by Lawrence Philips
...
CREATE FUNCTION `metaphone`(st VARCHAR(55)) RETURNS varchar(128) CHARSET utf8
    NO SQL
BEGIN
