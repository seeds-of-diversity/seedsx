...
while(mas_qg($mas,$temptt)){
	$content .= "<a style=\"text-decoration:none;\" href=".SL2URL."/".ttn($temptt,"tag_url")."\"><span style=\"color:#3333FF;\">".ttn($temptt,"tag_name")."</span></a>&nbsp;<span style=\"color:#B3B3B3;font-size:10px;\">".ttn($temptt,"total")." items with this tag</span><br />";
} mas_qe($mas);
