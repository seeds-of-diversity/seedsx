...
$s .= "<H2>Erb Street Snack Reminder</H2>"
    ...
    ."<TD>"
    ."Subject<BR/>"
    ."<INPUT type='text' name='email_subj' value='".SEEDStd_HSC($sSubj)."' style='width:100%'/>"
    ."<BR/><BR/>"
    ."From<BR/>"
    ."<INPUT type='text' name='email_from' value='".SEEDStd_HSC($sFrom)."' style='width:100%'/>"
    ."<BR/><BR/>"
    ."Bcc<BR/>"
    ."<INPUT type='text' name='email_bcc' value='".SEEDStd_HSC($sBcc)."' style='width:100%'/>"
    ."<BR/><BR/>"
    ."Email message<BR/>"
    ."<TEXTAREA style='width:100%' name='email_body' rows='15'>".SEEDStd_HSC($sBody)."</TEXTAREA>"
    ."<BR/><BR/>"
//    ."Recipients (email addresses separated by commas)<BR/>"
//    ."<TEXTAREA style='width:100%' name='email_list' rows='10'>".SEEDStd_HSC($sEmails)."</TEXTAREA>"
//    ."<BR/><BR/>"
    ...
    ."<BR/><BR/>"
    ."Notes<BR/>"
    ."<TEXTAREA style='width:100%' name='notes' rows='15'>".SEEDStd_HSC($sNotes)."</TEXTAREA>"
    ."</TD><TD width='40%'>"
