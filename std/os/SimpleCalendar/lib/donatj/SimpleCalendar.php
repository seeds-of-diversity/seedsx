...
class SimpleCalendar {
    ...
    public $raMonths = array( 'January', 'February', 'March', 'April', 'May', 'June',
    ...
    */
    public function addDailyHtml( $html, $start_date_string, $end_date_string = false ) {
        ...
        do {
            ...
            $working_date += 86400;
            $this->daily_html[$tDate['year']][$tDate['mon']][$tDate['mday']][] = $html;
    ...
    */
    public function show()
    {
        ...
        $out .= "<div class='SimpleCalendar_month'>".$this->raMonths[$this->now['mon']-1]." ".$this->now['year']."</div>";
        ...
        for( $i = 1; $i <= $no_days; $i++ ) {
            ...
            $out .= $this->DayContent( $this->now['year'], $this->now['mon'], $i );
    ...
    public function DayContent( $year, $mon, $day )
    {
        $out = "";

        if(isset( $this->daily_html[$year][$mon][$day] )) {
            $dHtml_arr = $this->daily_html[$year][$mon][$day];
