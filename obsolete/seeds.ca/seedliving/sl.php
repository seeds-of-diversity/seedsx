...
Seed Living Engine - Colin Mackenzie - Feb 1, 2010
                     Seeds of Diversity Canada 2013
***************************************************************/
...
//			$headers .= "bcc: sunshine@seedliving.ca\n";
	...
	case "productDetails":
		...
		if(file_exists(IMAGEROOT."seeds/".ttn($temptt,"seed_id")."_1.jpg")){
			...
			tkntbl_snprintf($gtt,"seed_image_1",1,MAX_RESULTS,"<img class='imgOver' src='".SL2URL.'/'.IMAGEROOT."seeds/%s_1.jpg' width='75px'/><br>",ttn($temptt,"seed_id"));
			if(file_exists(IMAGEROOT."seeds/".ttn($temptt,"seed_id")."_2.jpg")){
				tkntbl_snprintf($gtt,"seed_image_2",1,MAX_RESULTS,"<img class='imgOver' src='".SL2URL.'/'.IMAGEROOT."seeds/%s_2.jpg' width='75px'/><br>",ttn($temptt,"seed_id"));
			}
			if(file_exists(IMAGEROOT."seeds/".ttn($temptt,"seed_id")."_3.jpg")){
				tkntbl_snprintf($gtt,"seed_image_3",1,MAX_RESULTS,"<img class='imgOver' src='".SL2URL.'/'.IMAGEROOT."seeds/%s_3.jpg' width='75px'/><br>",ttn($temptt,"seed_id"));
			}
		} else {
		...
		while(list($key,$value) = each($_FILES[seed_image][name]))
		{
			if(!empty($value)){   // this will check if any blank field is entered
				...
				if($c==1){
					...
					$image->save(SEEDLIVING_ROOT_DIR."i/seeds/thmb/".ttn($tt,"@id")."_".$c.".jpg");
				}
			}
